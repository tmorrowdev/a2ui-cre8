/**
 * @a2ui-bridge/core - Core type definitions for A2UI protocol
...
/**
 * Interface for message processors that handle A2UI protocol messages.
 */
...
/**
 * Theme configuration for styling A2UI components.
 */
export type Theme = {
  components: {
...
export interface BadgeNode extends BaseComponentNode {
  type: 'Badge';
  properties: ResolvedBadge;
}

export interface SelectNode extends BaseComponentNode {
  type: 'Select';
  properties: ResolvedSelect;
}
...
export interface GridNode extends BaseComponentNode {
  type: 'Grid';
  properties: ResolvedGrid;
}
...
export type ResolvedBadge = Badge;
export type ResolvedSelect = Select;
